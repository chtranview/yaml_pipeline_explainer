...
打開 [Gemini](https://gemini.google.com/)，點擊左側「探索 Gem」→「新增 Gem」，建立自訂 Gem：

1. **名稱：** `ExpertAI Course Engine`
2. **指令：** 貼入以下內容：
...
3. 點擊「儲存」，之後在左側 Gem 清單中選取即可開始對話。

> **提示：** Gem 的指令長度上限寬裕，建議將常用的 0、1、2、6 一次貼入以獲得更一致的輸出。
